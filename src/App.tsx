    ...
    <div className="relative min-h-screen bg-midnight font-sans overflow-x-hidden select-none md:select-text">
              ...
              <div className="md:col-span-5 space-y-6">
                ...
                <div className="space-y-4 pt-4 border-t border-ivory/5 font-mono text-xs text-gold-accent/60">
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-gold-accent/40">
                      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 15.68l.05.3a6.32 6.32 0 0 0 11.23 2.68 6.27 6.27 0 0 0 1.25-3.83V9.16a8.21 8.21 0 0 0 3.82 1.48V7.15a5.1 5.1 0 0 1-1.76-.46z" />
                    </svg>
                    <a href="https://www.tiktok.com/@daianabooks?lang=it-IT" target="_blank" rel="noopener noreferrer" className="hover:text-gold-bright transition">@daianabooks su TikTok</a>
                  </div>
                </div>
              </div>
      ...
      >
        <footer className="relative py-16 bg-[#050810] border-t border-ivory/5 text-center text-xs font-mono text-gold-accent/40 uppercase tracking-widest z-10">
          ...
          <div className="flex justify-center pb-8 border-b border-ivory/5 max-w-2xl mx-auto">
            <a
              href="https://www.tiktok.com/@daianabooks?lang=it-IT"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-gold-accent/60 hover:text-gold-bright transition duration-300"
            >
